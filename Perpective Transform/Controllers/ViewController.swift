...
class ViewController: UIViewController {
    ...
    func setupViews() {
        ...
        vm.addADeviceView(containerView: containerView,deviceID: 2, deviceName: "Mac", coordinate: CGPoint(x: 150, y: 200), width: 60, height: 40)
        
        vm.addADeviceView(containerView: containerView,deviceID: 3, deviceName: "Mac 2", coordinate: CGPoint(x: 300, y: 400), width: 60, height: 40)
    ...
    func animateTransform() {
        ...
        for point in vm.points {
            ...
            deviceOfThisPoint?.view.layer.zPosition = 100
